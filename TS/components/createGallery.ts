...
const createGallery = (citiesArray: City[]) => {
  ...
  for (let city of citiesArray) {
    ...
    <!-- ${citiesArray.indexOf(city) + 1} item -->
      ...
      city.weatherDescription
              ...
              <p class="card-text">
                it's a beautiful ${
                  city.dayStatus /*0=night, 1=day*/ ? "day" : "evening"
                } in the fabulous ${city.cityName}! you'll experience ${
      city.weatherDescription
    } which is perfect for our cutomized tours!
              </p>
              <a href="https://meshulam.co.il/quick_payment?b=870a274b957d21562dfefa9416c4b5bc" target=”_blank” class="btn btn-primary">vist now for only ${
                city.price
              }$!</a>
            </div>
          </div>
