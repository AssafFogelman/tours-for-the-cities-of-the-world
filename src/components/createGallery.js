        ...
        <div class="col-4">
          <div class="card" style="width: 18rem; margin-top: 3rem">
            ...
            <div class="card-body">
              ...
              <p class="card-text">
                it's a beautiful ${city.dayStatus ? "day" : "evening"} in the fabulous ${city.cityName}! you'll experience ${city.weatherDescription} which is perfect for our cutomized tours!
              </p>
